...
By accessing, browsing, or using the Interface, or by acknowledging your agreement to the Terms on the Interface, you agree that you have read, understood, and consented to be bound by all of the Terms, including the [Privacy Policy](/privacy) which are incorporated by reference to these Terms.
...
7. **Interface relationship to Middleware**
...
8. # **Non-Custodial Wallet Connection**
...
- Liquid-staking tokens (stNEAR, liNEAR) carry additional validator and de-peg risk.
...
5. ## **Token Lists and Token Identification**
...
7. ## **User Responsibility for Accounts & Security**
...
8. ## **No Interface Fees; Third-Party Fees Irreversible**
...
12. ## **Essential Third-Party Software Dependencies**
...
16. # **No Investment, Legal, or Tax Advice**
...
19. # **Entire Representation, Consent and Agreement**
