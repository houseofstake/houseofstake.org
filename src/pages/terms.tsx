          ...
          <div className={styles.container}>
            <div className={styles.textContent}>
              ...
              <ul>
                ...
                <li>
                  <strong>Trademarks:</strong> Consectetur adipiscing elit
                </li>
                <li>
                  <strong>Copyright:</strong> Sed do eiusmod tempor incididunt
                </li>
                <li>
                  <strong>Patents:</strong> Ut labore et dolore magna aliqua
                </li>
              </ul>
              ...
              <p>
                THE LOREM IPSUM SERVICES ARE PROVIDED "AS IS" AND "AS AVAILABLE"
              ...
              <p>
                IN NO EVENT SHALL LOREM IPSUM BE LIABLE FOR ANY INDIRECT,
              ...
              <p>
                You agree to defend, indemnify and hold harmless Lorem Ipsum and
                its consectetur adipiscing elit from and against any and all
              ...
              <p>
                ...
                with the laws of Lorem Ipsum jurisdiction, without regard to its
              ...
              <p>
                If you have any questions about these Lorem Ipsum Terms of Use,
                please contact us at:{' '}
                <a href="mailto:legal@loremipsum.com">legal@loremipsum.com</a>
              </p>
            </div>
          </div>
        </section>
