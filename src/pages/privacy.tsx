...
export default function Privacy() {
  return (
    <>
      <Head>
        <title>Privacy Policy - House of Stake</title>
        <meta name="description" content="Privacy Policy for House of Stake" />
      </Head>
      <Header />
          ...
          <div className={styles.container}>
            <div className={styles.textContent}>
              ...
              <ul>
                ...
                <li>
                  <strong>Sed do eiusmod:</strong> Tempor incididunt ut labore
                ...
                <li>
                  <strong>Laboris nisi:</strong> Ut aliquip ex ea commodo
                  consequat
                </li>
                <li>
              ...
              <p>
                For any Lorem ipsum dolor sit amet questions, please contact us
                at: <a href="mailto:lorem@ipsum.com">lorem@ipsum.com</a>
              </p>
            </div>
          </div>
        </section>
