...
const CategoryCard = ({title, description, href}) => (
  <article className="col col--6 margin-bottom--lg">
    <Link
      ...
      <h2 className="text--truncate" title={title} style={{marginBottom: '0.5rem'}}>
        {title}
      </h2>
      <p className="text--truncate" title={description} style={{marginBottom: 0, color: 'var(--ifm-color-content-secondary)'}}>
        {description}
      </p>
    </Link>
  </article>
        ...
        <div className="container margin-vert--lg">
          <div className="text--center margin-bottom--xl">
            ...
            <p className="hero__subtitle">
              Welcome to the House of Stake documentation. Browse through our comprehensive guides and resources.
            </p>
          </div>
